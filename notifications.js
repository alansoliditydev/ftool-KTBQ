...
(function (b) {
  b.bigBox = function (a, h) {
    ...
    BigBoxes = BigBoxes + 1;
    k = "<div id='bigBox" + BigBoxes + "' class='bigBox animated fadeIn fast'><div id='bigBoxColor" + BigBoxes + "'><img class='botClose' id='botClose" + BigBoxes + "' src='images/close.png'>";
    k += "<span>" + a.title + "</span>";
    k += "<p>" + a.content + "</p>";
    k += "<div class='bigboxicon'>";
    if (a.img == undefined) {
      a.img = "images/cloud.png"
    }
    k += "<img src='" + a.img + "'>";
    k += "</div>";
...
(function (b) {
  b.smallBox = function (o, j) {
    ...
    if (isIE8orlower() == 0) {
      ...
      k.setAttribute("src", "sound/smallbox.mp3");
      b.get();
